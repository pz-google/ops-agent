...
Follow the [installation guide](https://cloud.google.com/stackdriver/docs/solutions/agents/ops-agent/third-party/apache) to collect logs and metrics from this application using Ops Agent.
